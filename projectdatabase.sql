...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2022 at 06:44 PM
...
--
-- Table structure for table `booking_custmer`
--

CREATE TABLE `booking_custmer` (
...
--
-- Dumping data for table `booking_custmer`
--

INSERT INTO `booking_custmer` (`booking_id`, `cust_id`, `model`, `type`, `color`, `finalprice`, `advance`, `deleverydate`) VALUES
(1, '3', 'Scrpio', '4wheelar', 'ttttt', '2000000', '67677', '2022-08-16'),
(2, '3', 'Scrpio', '4wheelar', 'ttttt', '2000000', '67677', '2022-08-10');
...
--
-- Indexes for table `booking_custmer`
--
ALTER TABLE `booking_custmer`
...
--
-- AUTO_INCREMENT for table `booking_custmer`
--
ALTER TABLE `booking_custmer`
  MODIFY `booking_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
