...
<body>
    ...
    <button onclick="location.href='mainpage2.php'" class="btn btn-success block"
        ...
        <button onclick="location.href='delevary2.php'" class="btn btn-success">DELIVERY</button>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-4 inputform">
                    ...
                    <button class="btn btn-warning" onclick="location.href='bookingpage2.php'">NEXT</button>
