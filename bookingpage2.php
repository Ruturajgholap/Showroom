<?php include('bookingpagedatabase.php') ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <button onclick="location.href='mainpage2.php'" class="btn btn-success block"
        ...
        <button onclick="location.href=''" class="btn btn-success">SERVICING</button>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 inputform">
                    <form method="post" action="bookingpage.php">
                        ...
                        <label for="">FULE TYPE :</label><br>
                        <select name="type" id="type" style="color:black;width=100%;"  class="form-select">
                        ...
                        <label for=""> ADVANCE PAYMENT:</label><br>
                        <input type="text" class="form-control" name="advances" ><br>
